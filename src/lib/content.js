...
export const projectList = [
  ...
  { id: 'lincoln', tag: 'Extension', duration: '12 weeks', cover: 'assets/img/lincoln.jpg', thumbA: 'assets/img/extension.jpg', thumbB: 'assets/img/lincoln.jpg', title: 'Lincoln Modern Home Extension', location: 'Lincoln, Lincolnshire', status: 'Completed', short: 'A contemporary extension maximising open-plan living and connecting the home to the garden.', body: 'A contemporary extension maximising open-plan living, seamlessly connecting the home to the garden with floor-to-ceiling bifold doors and bespoke finishes.', points: ['Open-plan living space', 'High-performance bifold doors', 'Bespoke finishes'],
  ...
  { id: 'grantham', tag: 'New Build', duration: '9 months', cover: 'assets/img/grantham.jpg', thumbA: 'assets/img/newbuild.jpg', thumbB: 'assets/img/grantham.jpg', title: 'Grantham Contemporary New Build', location: 'Grantham, Lincolnshire', status: 'Completed', short: 'A five-bedroom turn-key family home built to exacting specifications with eco-friendly features.', body: 'A stunning five-bedroom turn-key family home built to exacting specifications with eco-friendly features and bespoke structural glazing, designed for modern luxury.', points: ['Bespoke architectural design', 'Structural glazing façade', 'Energy-efficient systems'],
...
export const pages = {
  ...
  about: {
    ...
    drives: [
      { title: 'Our Mission', body: 'Crafting premium spaces from concept to completion — and building lasting trust in our community along the way.' },
      { title: 'Our Approach', body: 'Modern design meets traditional craftsmanship, with every project led on-site from first survey to final handover.' },
      { title: 'Quality & Craftsmanship', body: 'Premium materials and meticulous finishing on every build — all backed by our 10-year workmanship guarantee.' },
      { title: 'Local & Reliable', body: 'Lincolnshire-based and proud of it — delivered on time, on budget, with a single accountable point of contact.' },
    ],
    statsEyebrow: 'By The Numbers',
    statsHeading: 'Our results in numbers',
    processEyebrow: 'How We Work',
